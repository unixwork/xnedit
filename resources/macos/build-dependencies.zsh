...
src=(
	...
	"https://www.x.org/releases/individual/lib/xtrans-1.6.0.tar.gz"
	...
	"https://www.x.org/releases/individual/lib/libXft-2.3.9.tar.gz"
	"https://www.x.org/releases/individual/lib/libICE-1.1.2.tar.gz"
	"https://www.x.org/releases/individual/lib/libSM-1.2.6.tar.gz"
